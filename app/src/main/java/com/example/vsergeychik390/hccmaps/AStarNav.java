...
public class AStarNav {
    ...
    public List<String[]> getPath(int[] startCord, int[] endCord){
        ...
        Log.d("Start", String.valueOf(start[1]) + "," + String.valueOf(start[0]));
        Log.d("End", String.valueOf(goal[1]) + "," + String.valueOf(goal[0]));
        ...
        Log.d("Route Init: ", bestRoute.toString());
    ...
    String checkCordData(Vertex cCord){
        ...
        InputStream inputStream = context.getResources().openRawResource(R.raw.kittredge);
